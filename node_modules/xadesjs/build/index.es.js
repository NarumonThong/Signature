import { XmlElement, XmlObject, XmlCollection, XmlContent, XmlAttribute, XmlBase64Converter, XmlChildElement, XmlNumberConverter, XmlNodeType, XmlError, XE, Convert, assign } from 'xml-core';
export { Convert, Parse, Select } from 'xml-core';
import { DigestMethod, XmlSignature, X509IssuerSerial, Signature, CanonicalizationMethod, Transforms, DataObject as DataObject$1, SignedXml as SignedXml$1, Application, Reference, CryptoConfig, X509Certificate, XmlDsigC14NTransform, KeyInfoX509Data } from 'xmldsigjs';
...
class SignedXml extends SignedXml$1 {
    constructor(node) {
        super(node);
